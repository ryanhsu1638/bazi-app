...
const AIRules = (() => {
  ...
  // 格局成就特質對照（付費內容）
  // ------------------------------------------------------------
  // 這裡刻意不指名具體的真實歷史人物——多數歷史人物的確切出生時辰
  // 並無可靠記載，不同命理典籍對同一人物往往給出互相矛盾的八字，
  // 屬於難以查證的傳說性質。本專案改用「角色典型」的方式呈現：
  // 描述這類格局在歷史脈絡中常見成為哪一種角色定位、背後的原理是什麼，
  // 而不編造特定真人的出生時辰或八字內容。
  // ============================================================
  const GEJU_ACHIEVEMENT_PROFILE = {
    曲直格: {
      roleTypes: '領導改革的理念實踐者、教育傳承者、制度奠基者',
      reasoning: '木主仁、主生長與延展，一行得氣代表這股特質不受牽制、能徹底發揮。這類格局的人往往能在自己認定的理念或志業上長期堅持、持續拓展，容易成為某個領域裡奠定根基、影響深遠的關鍵人物。'
    },
    炎上格: {
      roleTypes: '具感染力的公眾人物、開創型企業家、擅長快速擴張版圖的領袖',
      reasoning: '火主禮、主光明與擴張，一行得氣代表能量集中噴發。這類格局的人容易在需要感染群眾、快速拓展影響力的場合發光發熱，是天生具有舞台魅力與號召力的類型。'
    },
    稼穡格: {
      roleTypes: '穩健的制度建立者、大型組織的中流砥柱、資產長期累積型經營者',
      reasoning: '土主信、主承載與包容，一行得氣代表根基極度扎實。這類格局的人做事按部就班、值得信賴，適合經營需要穩固基礎的長期事業，往往是組織裡最後屹立不搖的角色。'
    },
    從革格: {
      roleTypes: '紀律嚴明的專業人士、原則性強的決策者、講求精準的技術專家',
      reasoning: '金主義、主決斷與肅殺，一行得氣代表意志力極度集中且鋒利。這類格局的人做事講求原則、不輕易妥協，適合需要高度紀律與精準判斷的領域。'
    },
    潤下格: {
      roleTypes: '策略型智囊、跨界資源整合者、擅長預判趨勢的先行者',
      reasoning: '水主智、主流動與變通，一行得氣代表思維極度靈活且深遠。這類格局的人善於看穿局勢、預判趨勢，適合需要宏觀布局與靈活應變的角色。'
    },
    從財格: {
      roleTypes: '善於整合外部資源、白手起家的商業經營者',
      reasoning: '日主本身力量薄弱，代表這類人不執著於「靠自己硬撐」，而是懂得順勢借力、整合外部資源與機會。這種「不與大局對抗、反而順勢而為」的特質，往往能借勢造勢，成就遠超單打獨鬥所能達到的規模。'
    },
    從殺格: {
      roleTypes: '在體制或高壓環境中歷練崛起、後期身居要津的角色',
      reasoning: '日主力量薄弱卻整體氣勢一面倒向官殺（權威、壓力、體制），這類人早年往往經歷相當程度的磨練與服從，但正因為徹底放下與大局對抗的執念，反而容易在體制內或高壓環境中被拔擢重用，後期地位與影響力大幅提升。'
    },
    從兒格: {
      roleTypes: '才華洋溢、以創作或表達能力聞名的藝術家、創作者',
      reasoning: '日主力量薄弱卻氣勢一面倒向食傷（才華、表達、創造力），這類人往往從小展現超乎常人的天賦，且因為不執著於「證明自己」，反而能徹底放開手腳揮灑創意，容易在藝術、創作、表達等領域達到常人難以企及的高度。'
    },
    殺印相生格: {
      roleTypes: '能在龐大壓力下穩住大局的統帥型人物、危機處理專家、逆境中臨危受命的領導者',
      reasoning: '七殺代表外在的挑戰與壓力，印星代表化解與滋養的資源，兩者相生代表這類人天生具備「愈挫愈勇」的體質——壓力不會擊垮他們，反而會被轉化成成長的養分。這正是歷史上許多在動盪局勢中臨危受命、力挽狂瀾的人物，共通的命理結構原理。'
    },
    官印相生格: {
      roleTypes: '體制內穩健晉升、聲望與地位同步累積的管理者',
      reasoning: '正官代表制度與責任，印星代表資源與名聲，兩者相生代表責任的承擔能持續轉化為聲望與資源的累積，形成正向循環的結構，適合在有明確晉升軌道的體制或組織中，穩健地一步步走向高位。'
    },
    食神制殺格: {
      roleTypes: '以柔克剛的談判者、危機調解專家、擅長化解衝突的溝通者',
      reasoning: '食神代表從容、才華與情緒智商，七殺代表外在的挑戰與衝突，食神能制衡七殺代表這類人不需要正面硬碰硬，而是懂得用更高明、更從容的方式化解對立與壓力，是天生的危機調解與談判高手。'
    },
    傷官配印格: {
      roleTypes: '才華洋溢卻不恃才傲物、能將創意轉化為實際成果的專業人士',
      reasoning: '傷官代表創意與表達欲，印星能適度收斂傷官的鋒芒，讓聰明才智不流於賣弄，而是被導正、聚焦在真正有價值的方向上。這類人是「有才華又懂得剋制」的稀有組合，容易在專業領域做出經得起時間考驗的成果。'
    },
    財多身弱格: {
      roleTypes: '早年機會眾多、需要學習駕馭資源的後發型人物',
      reasoning: '財星旺代表機會與資源俯拾即是，但日主力量偏弱代表消化與掌控的能力尚未跟上。這類人的人生課題往往是學習如何篩選、聚焦、真正駕馭手中的資源，一旦跨過這個學習曲線，反而容易後發先至。'
    },
    身強財旺格: {
      roleTypes: '能力與機會同步到位、白手起家的實業經營者',
      reasoning: '日主力量強健代表有足夠的能力去承接與消化機會，財星旺代表機會與資源本身就充沛，兩者兼備是命理上公認相對難得的組合，這類人通常不缺機會，也有能力把機會轉化為實質成果。'
    },
    正官格: { roleTypes: '體制內穩健發展、值得託付重任的管理者', reasoning: '正官代表制度、責任與紀律，這類特質鮮明的人天生讓人放心託付，容易在需要穩定治理與制度建立的位置上發光發熱。' },
    七殺格: { roleTypes: '敢於承擔風險、開創格局的開拓者', reasoning: '七殺代表決斷力與行動力，這類特質鮮明的人不畏懼挑戰與競爭，容易在需要破局開創的階段成為關鍵角色。' },
    正財格: { roleTypes: '穩健踏實、長期累積實質成果的經營者', reasoning: '正財代表務實與紀律，這類特質鮮明的人重視長期價值而非短期投機，容易在需要穩健經營的領域建立起扎實的基礎。' },
    偏財格: { roleTypes: '善於整合資源、掌握商機的多元經營者', reasoning: '偏財代表靈活的機會財與人脈整合能力，這類特質鮮明的人天生對商機敏感，容易在需要跨界整合的領域開展出多元版圖。' },
    食神格: { roleTypes: '溫和從容、以生活美學或創作見長的角色', reasoning: '食神代表才情與生活品味，這類特質鮮明的人擅長把事情做得讓人感到舒服愉悅，容易在需要美感與細膩度的領域建立口碑。' },
    傷官格: { roleTypes: '才華洋溢、勇於打破框架的創新者', reasoning: '傷官代表創意與表達欲，這類特質鮮明的人不安於現狀、敢於挑戰既有規則，容易在需要創新突破的領域嶄露頭角。' },
    正印格: { roleTypes: '學識淵博、值得信賴的傳承者', reasoning: '正印代表知識與內在修養的累積，這類特質鮮明的人重視深度而非速度，容易在需要專業累積與傳承的領域建立權威地位。' },
    偏印格: { roleTypes: '特立獨行、在冷門領域深耕的專精者', reasoning: '偏印代表獨特且不隨大流的思維方式，這類特質鮮明的人往往能在別人不曾留意的角落，鑽研出獨到的專業深度。' },
    比肩格: { roleTypes: '獨立自主、憑一己之力打天下的開創者', reasoning: '比肩代表自主性與行動力，這類特質鮮明的人不依賴他人，容易靠自己的努力開創出一片天地。' },
    劫財格: { roleTypes: '人脈廣闊、善於整合團隊力量的協作者', reasoning: '劫財代表社交能量與資源共享的特質，這類特質鮮明的人善於凝聚人脈與團隊，容易在需要協作整合的場合發揮影響力。' }
  };
  ...
  function generateFullAnalysis(chart, gender, wuxingRatio) {
    ...
    // ---------- 付費：格局成就特質（角色典型，非具體真人）----------
    const gejuProfile = GEJU_ACHIEVEMENT_PROFILE[gejuInfo.name];
    const gejuAchievement = gejuProfile
      ? `你的命局屬於「${gejuInfo.name}」（${gejuInfo.category}）。\n\n${gejuInfo.teaser}\n\n【常見角色典型】${gejuProfile.roleTypes}\n\n【成就特質的原理】${gejuProfile.reasoning}\n\n※ 說明：命理典籍中討論格局時，常會援引歷史人物作為示範，但多數歷史人物的確切出生時辰並無可靠記載，不同命理書籍對同一人物往往給出互相矛盾的八字，屬於難以查證的傳說性質。這裡刻意採用「角色典型」呈現方式，聚焦在這個格局背後的原理與常見的成就路徑，而不編造特定真人的出生資料。`
      : `你的命局屬於「${gejuInfo.name}」（${gejuInfo.category}）。\n\n${gejuInfo.teaser}`;
