...
- ✅ **季節用神提醒**：依日主五行 × 出生季節，提示簡化版「調候用神」參考（免費內容）
...
依「日主五行 × 出生季節」提供簡化版的調候參考（傳統命理稱為「調候用神」，
概念是不同季節出生的人，五行會偏冷/偏熱/偏燥/偏濕，需要對應的五行來平衡）。

這是**原創簡化版本**（依日主五行 5 種 × 季節 4 種，共 20 組），文字說明由本專案
自行撰寫，並非參考坊間特定命理師的品牌化內容（例如坊間流傳的「餓命學」是
特定命理師的自創命名與品牌化建議清單，本功能核心概念雖同樣源自傳統「調候」，
但內容與分類方式完全獨立撰寫，並未引用其命名或建議清單）。

完整的傳統調候用神理論會精確到「日主天干 × 出生月份」共 120 種組合，
並綜合考量四柱其餘干支的互動，本功能僅為簡化參考，並非命理定論。
